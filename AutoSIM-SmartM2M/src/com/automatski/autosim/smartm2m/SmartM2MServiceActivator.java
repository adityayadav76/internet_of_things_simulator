...
import com.automatski.autosim.smartm2m.config.AutoSIMSmartM2MConfig;
import com.automatski.autosim.smartm2m.config.AutoSIMConnectionConfig;
import com.automatski.autosim.smartm2m.utils.GsonUtils;
...
public class SmartM2MServiceActivator implements BundleActivator
{
	private IEnvironments environments = null;
	private AutoSIMSmartM2MConfig config = null;
	private HashMap<String,SmartM2MConnectionFactory> factories = new HashMap<String,SmartM2MConnectionFactory>();
    ...
    **/
    public void start(BundleContext context) throws Exception 
    {
    	...
    	for (AutoSIMConnectionConfig connectionConfig : config.connections){
			SmartM2MConnectionFactory factory = new SmartM2MConnectionFactory(connectionConfig);
