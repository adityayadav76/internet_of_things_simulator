 ...
 */
package com.automatski.autosim.lwm2m;
...
import com.automatski.autosim.lwm2m.config.AutoSIMConnectionConfig;
import com.automatski.autosim.lwm2m.config.AutoSIMMQTTConfig;
import com.automatski.autosim.lwm2m.utils.GsonUtils;
...
public class LWM2MServiceActivator implements BundleActivator
{
	private IEnvironments environments = null;
	private AutoSIMMQTTConfig config = null;
	private HashMap<String,LWM2MConnectionFactory> factories = new HashMap<String,LWM2MConnectionFactory>();
    ...
    **/
    public void start(BundleContext context) throws Exception 
    {
    	...
    	for (AutoSIMConnectionConfig connectionConfig : config.connections){
			LWM2MConnectionFactory factory = new LWM2MConnectionFactory(connectionConfig);
