...
import com.automatski.autosim.xmpp.config.AutoSIMXMPPConfig;
import com.automatski.autosim.xmpp.config.AutoSIMConnectionConfig;
import com.automatski.autosim.xmpp.utils.GsonUtils;
    ...
    **/
    public void start(BundleContext context) throws Exception 
    {
    	...
    	for (AutoSIMConnectionConfig connectionConfig : config.connections){
			XMPPConnectionFactory factory = new XMPPConnectionFactory(connectionConfig);
