...
import com.automatski.autosim.websocket.config.AutoSIMWebSocketConfig;
...
public class WebSocketServiceActivator implements BundleActivator
{
	private IEnvironments environments = null;
	private AutoSIMWebSocketConfig config = null;
	private HashMap<String,WebSocketConnectionFactory> factories = new HashMap<String,WebSocketConnectionFactory>();
    ...
    **/
    public void start(BundleContext context) throws Exception 
    {
    	...
    	for (AutoSIMConnectionConfig connectionConfig : config.connections){
			WebSocketConnectionFactory factory = new WebSocketConnectionFactory(connectionConfig);
