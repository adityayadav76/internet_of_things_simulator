...
import com.automatski.autosim.amqp.config.AutoSIMAMQPConfig;
import com.automatski.autosim.amqp.config.AutoSIMConnectionConfig;
import com.automatski.autosim.amqp.utils.GsonUtils;
...
public class AMQPServiceActivator implements BundleActivator
{
	private IEnvironments environments = null;
	private AutoSIMAMQPConfig config = null;
	private HashMap<String,AMQPConnectionFactory> factories = new HashMap<String,AMQPConnectionFactory>();
    ...
    **/
    public void start(BundleContext context) throws Exception 
    {
    	...
    	for (AutoSIMConnectionConfig connectionConfig : config.connections){
			AMQPConnectionFactory factory = new AMQPConnectionFactory(connectionConfig);
