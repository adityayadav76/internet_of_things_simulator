...
import com.automatski.autosim.coap.config.AutoSIMCoAPConfig;
import com.automatski.autosim.coap.utils.GsonUtils;
...
public class CoAPServiceActivator implements BundleActivator
{
	private IEnvironments environments = null;
	private AutoSIMCoAPConfig config = null;
	private HashMap<String,CoAPConnectionFactory> factories = new HashMap<String,CoAPConnectionFactory>();
    ...
    **/
    public void start(BundleContext context) throws Exception 
    {
    	...
    	for (AutoSIMConnectionConfig connectionConfig : config.connections){
			CoAPConnectionFactory factory = new CoAPConnectionFactory(connectionConfig);
